        ...
        <div class="notes-grid">
          {% for post in site.posts limit:5 %}
            <article class="note-card">
              <a href="{{ post.url | relative_url }}" class="note-cover-link">
                {% if post.cover %}
                  <img class="note-cover" src="{{ post.cover | relative_url }}" alt="">
                {% else %}
                  <div class="note-cover-placeholder" role="img" aria-label="Placeholder"></div>
                {% endif %}
              </a>
